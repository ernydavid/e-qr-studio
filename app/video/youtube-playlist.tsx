...
declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      'lite-youtube': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, LiteYTEmbed> & { videoid: string; playlistid?: string, autoload?: boolean, videoStartAt?: string, params?: string, posterquality?: string, className?: string };
    }
  }
}

export function YoutubePlaylist ({ youtubeLink }: {
  youtubeLink?: string
}) {
  if (!youtubeLink) {
    return (
